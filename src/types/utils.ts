...
import { MetaMaskProviderType } from "./wallet";
...
export type ActionType =
  | {
      ...
      provider?: MetaMaskProviderType["provider"];
      web3Provider?: MetaMaskProviderType["web3Provider"];
      address?: MetaMaskProviderType["address"];
      chainId?: MetaMaskProviderType["chainId"];
    }
  | {
      type: "SET_ADDRESS";
      address?: MetaMaskProviderType["address"];
